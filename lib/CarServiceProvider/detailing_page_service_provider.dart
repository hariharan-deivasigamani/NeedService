...
class CarMachDetailPage extends StatefulWidget {
  const CarMachDetailPage({Key? key}) : super(key: key);

  @override
  State<CarMachDetailPage> createState() => _CarMachDetailPageState();
}

class _CarMachDetailPageState extends State<CarMachDetailPage> {
